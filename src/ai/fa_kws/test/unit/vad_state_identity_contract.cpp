...
TEST(VadStateIdentityContract, AcceptsMatchingAudioBinding)
{
  ...
  EXPECT_TRUE(fa_kws::vadStateMatchesAudioBinding(msg, "mic-a", "audio/frame"));
}
...
TEST(VadStateIdentityContract, RejectsMissingVadIdentity)
{
  ...
  EXPECT_FALSE(fa_kws::vadStateMatchesAudioBinding(missing_source, "mic-a", "audio/frame"));
  EXPECT_FALSE(fa_kws::vadStateMatchesAudioBinding(missing_stream, "mic-a", "audio/frame"));
}
...
TEST(VadStateIdentityContract, RejectsMissingExpectedBinding)
{
  ...
  EXPECT_FALSE(fa_kws::vadStateMatchesAudioBinding(msg, "", "audio/frame"));
...
TEST(VadStateIdentityContract, RejectsUnexpectedSourceOrStream)
{
  ...
  EXPECT_FALSE(fa_kws::vadStateMatchesAudioBinding(msg, "mic-b", "audio/frame"));
