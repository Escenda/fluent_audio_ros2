...
def test_fa_speaker_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "external_speaker_model.md").is_file()


def test_fa_speaker_is_not_declared_as_ros_package_before_contract_completion() -> None:
