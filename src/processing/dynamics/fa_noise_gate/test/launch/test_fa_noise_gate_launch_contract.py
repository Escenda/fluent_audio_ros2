...
def test_example_launch_config_keeps_noise_gate_as_dynamics_node() -> None:
...
def test_launch_fails_closed_when_stream_ids_are_not_distinct(tmp_path: Path) -> None:
    ...
    config["fa_noise_gate"]["ros__parameters"]["output"]["stream_id"] = "audio/dc_offset_removed/mic"
...
def test_launch_fails_closed_when_stream_id_matches_topic(tmp_path: Path) -> None:
    ...
    config["fa_noise_gate"]["ros__parameters"]["input_stream_id"] = "fa_noise_gate/output"
...
def test_launch_fails_closed_when_output_stream_id_matches_topic(tmp_path: Path) -> None:
    ...
    config["fa_noise_gate"]["ros__parameters"]["output"]["stream_id"] = "fa_noise_gate/input"
