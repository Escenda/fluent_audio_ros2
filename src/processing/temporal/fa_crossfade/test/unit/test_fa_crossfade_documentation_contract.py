...
def test_fa_crossfade_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "internal_crossfade.md").is_file()


def test_fa_crossfade_is_not_declared_as_ros_package_before_contract_completion() -> None:
