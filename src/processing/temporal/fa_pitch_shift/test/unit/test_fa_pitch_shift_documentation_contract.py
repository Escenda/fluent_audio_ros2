...
def test_fa_pitch_shift_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "phase_vocoder_pitch_shift.md").is_file()


def test_fa_pitch_shift_is_not_declared_as_ros_package_before_contract_completion() -> None:
