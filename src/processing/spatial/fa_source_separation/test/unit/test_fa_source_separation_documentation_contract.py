...
def test_fa_source_separation_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "external_separator.md").is_file()


def test_fa_source_separation_is_not_ros_package_before_contract_completion() -> None:
