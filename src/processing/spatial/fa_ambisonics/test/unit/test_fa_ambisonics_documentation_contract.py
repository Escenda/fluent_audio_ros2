...
def test_fa_ambisonics_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "ambisonic_transform.md").is_file()


def test_fa_ambisonics_is_not_declared_as_ros_package_before_contract_completion() -> None:
