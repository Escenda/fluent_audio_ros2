...
def test_fa_speech_enhancement_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "external_speech_enhancer.md").is_file()


def test_fa_speech_enhancement_is_not_ros_package_before_contract_completion() -> None:
