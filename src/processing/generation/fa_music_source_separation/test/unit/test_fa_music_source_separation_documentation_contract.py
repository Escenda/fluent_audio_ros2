...
def test_fa_music_source_separation_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "external_music_separator.md").is_file()


def test_fa_music_source_separation_is_not_ros_package_before_contract_completion() -> None:
