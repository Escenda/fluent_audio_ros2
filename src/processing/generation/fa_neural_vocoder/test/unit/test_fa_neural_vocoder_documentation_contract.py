...
def test_fa_neural_vocoder_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "external_neural_vocoder.md").is_file()


def test_fa_neural_vocoder_is_not_declared_as_ros_package_before_contract_completion() -> None:
