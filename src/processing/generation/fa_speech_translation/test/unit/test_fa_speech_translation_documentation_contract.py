...
def test_fa_speech_translation_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "external_speech_translation.md").is_file()


def test_fa_speech_translation_is_not_declared_as_ros_package_before_contract_completion() -> None:
