...
def test_fa_voice_conversion_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "external_voice_conversion.md").is_file()


def test_fa_voice_conversion_is_not_declared_as_ros_package_before_contract_completion() -> None:
