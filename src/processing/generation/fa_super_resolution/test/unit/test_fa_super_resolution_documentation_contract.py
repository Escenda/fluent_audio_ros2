...
def test_fa_super_resolution_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "external_audio_super_resolution.md").is_file()


def test_fa_super_resolution_is_not_declared_as_ros_package_before_contract_completion() -> None:
