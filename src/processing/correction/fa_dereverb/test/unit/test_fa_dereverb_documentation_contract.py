...
def test_fa_dereverb_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "reverb_suppression.md").is_file()


def test_fa_dereverb_is_not_declared_as_ros_package_before_contract_completion() -> None:
