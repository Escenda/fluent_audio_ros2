...
def test_fa_spectral_subtraction_has_standard_design_documents() -> None:
    ...
    assert (PACKAGE_ROOT / "docs" / "backends" / "stft_noise_profile.md").is_file()


def test_fa_spectral_subtraction_is_not_ros_package_before_contract_completion() -> None:
