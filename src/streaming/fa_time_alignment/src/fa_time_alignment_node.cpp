...
void FaTimeAlignmentNode::loadParameters()
{
  ...
  config_.alignment_period_ms = this->get_parameter("alignment.period_ms").as_double();
  config_.alignment_phase_ms = this->get_parameter("alignment.phase_ms").as_double();
  config_.alignment_max_adjust_ms = this->get_parameter("alignment.max_adjust_ms").as_double();
